...
local active_background_color = beautiful.bars_background or "#222222"
local muted_background_color = beautiful.bars_background or "#222222"
...
awesome.connect_signal("volume::update", function(volume, muted)
    local bg_color
    if muted then
